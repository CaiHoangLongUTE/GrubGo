...
function FoodCard({ data }) {
    ...
    return (
        <div className='w-[250px] rounded-2xl border-2 border-[#ff4d2d] bg-white shadow-md overflow-hidden hover:shadow-xl
        transition-all duration-300 flex flex-col'>
            ...
            <div className='flex items-center justify-between mt-auto p-3'>
                ...
                <div className='flex items-center border rounded-full overflow-hidden shadow-sm'>
                    ...
                    <button className='bg-[#ff4d2d] text-white px-3 py-2 transition-colors'><FaShoppingCart /></button>
                </div>
            </div>
