    ...
    <div className="flex bg-white rounded-2xl shadow-md hover:shadow-lg transition-shadow duration-300 overflow-hidden border border-gray-100 w-full max-w-xl">
      ...
      <div className="flex flex-col justify-between p-3 flex-1">
        <div>
          ...
          <p className="text-sm text-gray-500"><span className="font-medium text-gray-700">Loại:</span> {data.category}</p>
          <p className="text-sm text-gray-500"><span className="font-medium text-gray-700">Loại thức ăn:</span> <span className="capitalize">{data.foodType === 'veg' ? 'Chay' : 'Mặn'}</span></p>
        </div>
